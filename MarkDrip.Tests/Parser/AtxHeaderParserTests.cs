...
public class AtxHeaderParserTests
{
    ...
    public void Append_StripsHashPrefix(string line, string expectedText)
    {
        ...
        var completed = parser.Append(line, ctx);
    ...
    public void Append_WithNewline_ReturnsTrue()
    {
        ...
        var completed = parser.Append("# Hello\n", ctx);
    ...
    public void Append_NewlineOnly_ReturnsTrueAndNoContent()
    {
        ...
        parser.Append("# hi", ctx);

        // Newline-only chunk
        var completed = parser.Append("\n", ctx);
    ...
    public void Append_Continuation_AppendsText()
    {
        ...
        parser.Append("## Hel", ctx);

        // Continuation
        var completed = parser.Append("lo\n", ctx);
    ...
    public void Append_ContinuationWithoutNewline_ReturnsFalse()
    {
        ...
        parser.Append("# He", ctx);

        var completed = parser.Append("llo", ctx);
    ...
    public void Append_ContinuationWithNewline_ReturnsTrue()
    {
        ...
        var completed = parser.Append("llo\n", ctx);
    ...
    public void Append_MultipleContinuations()
    {
        ...
        parser.Append("## A", ctx);     // first = "A"
        parser.Append("B", ctx);        // continuation
        parser.Append("C", ctx);        // continuation

        var completed = parser.Append("D\n", ctx);
